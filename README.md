This code works by saving information to text files and then reading in this information every time the program is booted up. Different types of files could be used but TXT files 
